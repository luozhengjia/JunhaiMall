...
<body>
<form id="orderReplForm"  name="orderReplForm" action="updateConsigneeInfo.sc"  method="post" >
    ...
    <div id="modify" class="modify">
		...
		<table class="com_modi_table">
			<tbody>
				...
				<tr>
					<th></th>
					<td><input type="button" value="保存" onclick="updateConsigneeInfo();" class="btn-save"/>
		 ...
		 <div class="detail_top_box">
			<table>
				<tr>
					...
					<td width="320px">${orderRepl.consignee?default("")}</td>
					<th width="80px">手机：</th>
					<td width="420px">${orderRepl.mobilePhone?default("")}</td>
				</tr>
				<tr>
					<th width="80px">订单金额:</th>
					<td width="320px">${orderRepl.payAmount?c}</td>
		...
		<div class="detail_top_box">
			<table>
				<tr>
					...
					<td width="320px">${orderRepl.logisticsCompany?default("")}</td>
					<th width="80px">运单号：</th>
					<td width="420px">${orderRepl.expressOrderNo?default("")}</td>
				</tr>
				<tr>
					<th width="80px">物流信息：</th>
					<td width="600px" colspan="3">暂未查询到相关物流信息</td>
				</tr>
			</table>
		</div>
		</#if>
